...
# every class creates a table with their attributes. These attributes have constrictions. 
#These tables are used in the post method to save data which is generated by forms
